...
## save model weights 
torch.save(model_ft.state_dict(), './model_weightsR34SGD0.01.pth')
...
plt.ylabel("Accuracy")
plt.title("Accuracy of Resnet34")
...
loaded_model, class_to_idx = load_model('./model_weightsR34SGD0.01.pth')
